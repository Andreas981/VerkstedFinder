...
namespace VerkstedFinder.Context.Migrations
{
    ...
    [Migration("20190425113110_RemovedPermissionTables")]
    partial class RemovedPermissionTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VerkstedFinder.Model.Workshop", b =>
                {
                    b.HasOne("VerkstedFinder.Model.Poststed", "Postnr1")
                        .WithMany()
                        .HasForeignKey("Postnr1Postnr")
                        .OnDelete(DeleteBehavior.Cascade);
                });
