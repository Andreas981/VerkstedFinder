#pragma checksum "D:\net\VerkstedFinder\VerkstedFinder.App\Views\SearchViewPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "870A3B3A3116CB55C1B76A7EBE757DFB"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace VerkstedFinder.App.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ISearchViewPage_Bindings
        {
            ...
            {
                if (lineNumber == 25 && columnNumber == 147)
                {
                    isobj4TextDisabled = true;
                }
                else if (lineNumber == 27 && columnNumber == 180)
                {
                    isobj5TextDisabled = true;
                }
                else if (lineNumber == 28 && columnNumber == 117)
                {
                    isobj6TextDisabled = true;
                }
                else if (lineNumber == 29 && columnNumber == 137)
                {
                    isobj7TextDisabled = true;
                }
                else if (lineNumber == 30 && columnNumber == 137)
                {
                    isobj8TextDisabled = true;
                }
                else if (lineNumber == 31 && columnNumber == 137)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 3: // Views\SearchViewPage.xaml line 16
                        ...
                        break;
                    case 4: // Views\SearchViewPage.xaml line 25
                        this.obj4 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 5: // Views\SearchViewPage.xaml line 27
                        this.obj5 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 6: // Views\SearchViewPage.xaml line 28
                        this.obj6 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 7: // Views\SearchViewPage.xaml line 29
                        this.obj7 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 8: // Views\SearchViewPage.xaml line 30
                        this.obj8 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 9: // Views\SearchViewPage.xaml line 31
            ...
            private void Update_(global::VerkstedFinder.App.Core.Models.Workshop obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_Postnr1(obj.Postnr1, phase);
                    }
                }
            }
            private void Update_Ws_name(global::System.String obj, int phase)
            {
                ...
                {
                    // Views\SearchViewPage.xaml line 25
            ...
            private void Update_Ws_orgnumber(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\SearchViewPage.xaml line 27
            ...
            private void Update_Postnr1(global::VerkstedFinder.App.Core.Models.Poststed obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_Postnr1_Postnr(obj.Postnr, phase);
                        this.Update_Postnr1_PoststedName(obj.PoststedName, phase);
                    }
                }
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Postnr1_Postnr(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Postnr1_PoststedName(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
